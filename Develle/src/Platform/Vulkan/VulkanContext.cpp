...
VulkanContext::VulkanContext(SDL_Window* window, const VulkanContextCreateOptions& options)
    : window(window) {
...
const std::vector<const char*> VulkanContext::GetRequiredExtensions(SDL_Window* window) {
...
void VulkanContext::pickPhysicalDevice(
    std::vector<vk::PhysicalDevice> devices) {  // TODO put some thought into this
  for (auto d : devices) {
    physicalDevice = d;
    break;
  }

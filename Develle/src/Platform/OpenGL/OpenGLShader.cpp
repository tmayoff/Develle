...
static std::string GetCacheDirectory() { return std::string(ASSETS_ROOT) + "/cache/shader/opengl"; }
...
OpenGLShader::OpenGLShader(const std::string &filepath) : rendererID(-1), filepath(filepath) {
